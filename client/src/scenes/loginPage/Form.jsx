  ...
  const register = async (values, onSubmitProps) => {
    try {
      ...
      if (registerResponse.ok) {
        ...
        console.error(
          `Register failed with status: ${registerResponse.status} - ${registerResponse.statusText}`
        );
        console.error("Error data:", errorData);
        setRegisterError("Invalid registration."); // Set the login error message
      }
    } catch (error) {
  ...
  const login = async (values, onSubmitProps) => {
    try {
      ...
      if (loggedInResponse.ok) {
        ...
        console.error(
          `Login failed with status: ${loggedInResponse.status} - ${loggedInResponse.statusText}`
        );
        console.error("Error data:", errorData);
